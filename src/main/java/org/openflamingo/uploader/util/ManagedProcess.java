...
import org.openflamingo.uploader.exception.ProcessFailureException;
...
/**
 * {@link java.lang.Process}의 관리 기능을 제공하기 위한 Process.
...
public class ManagedProcess {
    ...
    public void run() throws IOException {
        ...
        if (processId == 0) {
            logger.debug("프로세스 ID를 알 수 없습니다.");
        } else {
            logger.debug("프로세스 ID : " + processId);
        }
