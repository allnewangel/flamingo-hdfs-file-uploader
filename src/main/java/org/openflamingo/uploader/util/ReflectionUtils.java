...
/**
 * Java Reflection 유틸리티 클래스. 이 유티릴티 클래스를 통해서 Java Reflection과 관련된 다양한 API를 손쉽게 사용할 수 있다.
 *
 * @author Edward KIM
 * @version 0.1
 */
public class ReflectionUtils {
     ...
     * @throws SystemException 클래스를 찾을 수 없는 경우
     * @see Class#forName(String, boolean, ClassLoader)
     * @see #getDefaultClassLoader()
     */
    public static Class forName(String className) throws SystemException {
        try {
            return org.springframework.util.ClassUtils.forName(className);
        } catch (ClassNotFoundException e) {
            throw new SystemException("[" + className + "] 클래스를 현재 클래스 로더의 CLASSPATH에서 찾을 수 없습니다.", e);
        }
    }
    ...
    /**
     * 지정한 클래스의 qualified 명을 반환한다. 예를 들면 "ClassUtils"의 경우 "com.skt.ccme.pilot.util.ClassUtils"를 반환한다.
     *
     * @param clazz 클래스
     * @return 클래스의 qualified 명
     */
    ...
    public static Object invokeMethod(Method method, Object instance) {
        if (logger.isTraceEnabled()) {
            ...
            logger.trace("{} 클래스의 {} 메소드가 호출되었습니다.", className, getMethodSignature(method));
        }
    ...
    public static Object invokeMethod(Method method, Object instance, Object[] args) {
        if (logger.isTraceEnabled()) {
            String className = instance.getClass().getName();
            logger.trace("{} 클래스의 {} 메소드가 호출되었습니다.", className, getMethodSignature(method, args));
        }
     ...
     * @return 호출 결과
     * @throws SystemException 메소드를 호출할 수 없는 경우
     */
    public static Object invokeMethod(String className, String methodName, String parameterType, Object parameterValue) throws SystemException {
        if (logger.isTraceEnabled()) {
            logger.trace("{} 클래스의 [{}({}({}))] 메소드가 호출되었습니다.", new Object[]{
                className, methodName, parameterType, parameterValue
            });
        }
        Class clazz = null;
        try {
            ...
            throw new SystemException("[" + className + "]에 접근할 수 없습니다.", e);
        } catch (InstantiationException e) {
            throw new SystemException("[" + className + "]의 인스턴스를 생성할 수 없습니다.", e);
        }
    }
    ...
    public static Object invokeMethod(Object instance, String name, Object arg) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        if (logger.isTraceEnabled()) {
            logger.trace("{} 클래스의 [{}({}({}))] 메소드가 호출되었습니다.", new Object[]{
                instance.getClass().getName(), name, arg.getClass().getName(), arg
            });
        }
    ...
    public static Object invokeMethod(Object instance, String name, Object[] args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        if (logger.isTraceEnabled()) {
            ...
            logger.trace("{} 클래스의 [{}({})] 메소드가 호출되었습니다.", new Object[]{
                instance.getClass().getName(), name, methodParameter
            });
        }
     ...
     * @return 인스턴스
     * @throws SystemException 인스턴스를 생성할 수 없는 경우
     */
     ...
     * @return Setter
     * @throws SystemException Setter를 반환할 수 없는 경우
     */
    public static Method getSetterMethod(Object instance, String fieldName) throws SystemException {
        try {
            ...
            throw new SystemException("[" + instance.getClass().getName() + "] 클래스에 대한 [" + fieldName + "] 필드의 Setter를 찾을 수 없습니다.", e);
        }
    }
     ...
     * @param fieldName 인스턴스 필드
     * @return Getter
     * @throws SystemException Getter를 반환할 수 없는 경우
     */
    public static Method getGetterMethod(Object instance, String fieldName) throws SystemException {
        try {
            ...
            throw new SystemException("[" + instance.getClass().getName() + "] 클래스에 대한 [" + fieldName + "] 필드의 Getter를 찾을 수 없습니다.", e);
        }
    }
}